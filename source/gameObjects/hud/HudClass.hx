...
class HudClass extends FlxGroup
{
	...
	public function new()
	{
		...
		badScoreTxt = new FlxText(0,0,0,"YOUR SCORE WILL NOT BE SAVED, CHEATER!!!");
		...
		botplayTxt = new FlxText(0,0,0,"[ASSHOLE MODE]");
	...
	public function updateText()
	{
		...
		infoTxt.text += separator + 'Combo Breaks: '		+ Timings.misses;
